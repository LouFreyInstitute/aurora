		...
		<section className="section is-large">
			<div className="container is-large">
				<div className="boxes o-layout is-horizontal">
					<div className="box is-brand is-large o-layout-item is-fill">
						...
						<p>
							Written in SCSS, this is the foundation of Aurora used to build
							out user interfaces and web applications.
						</p>
					...
					<div className="box is-large">
						...
						<p>
							React components that use <em>Elements</em> classes for styling.
							You can also supply your own <code>className</code> property.
						</p>

						<h2 className="c-heading is-small">Aurora Icons</h2>
						<p>
							Custom vector SVG icons to be used in <em>Components</em>. It
							should be possible to copy the SVG paths and inline them
							independently, though.
						</p>
						<h2 className="c-heading is-small">Aurora Avatars</h2>
						<p>
							A framework for building user avatars. A set of SVG graphics that
							are customizable by the user. Your users will enjoy creating an
							avatar that suits their personality.
						</p>
					</div>
				</div>
			</div>
