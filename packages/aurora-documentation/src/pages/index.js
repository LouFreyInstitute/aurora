...
const IndexPage = () => (
	<Layout>
		...
		<p>
			...
			which always seemed to be over-engineered or bloated, and a want to be as
			minimalist as possible. Chances are, if you use this product, more code
			and features will be removed than added.
		</p>
